...
export default function SignUp() {
    ...
    //모달
    const[servicePermition,setServicePermition]=useState(false);
    ...
    const onChangeSignUpName = (e) => {
        ...
        if (currentName.length < 2 || currentName.length > 5) {
            setSignUpNameMassage("이름을 입력해주세요");
                ...
                <article className="FormWrap">
                    <form className="InfoForm" action="server.html" name="memberJoin">
                        <div className="idInputWrap">
                            {/* <p>아이디</p> */}
                            <InputBox type="text" label="아이디" name="id" className="signUpId" minLength={5} maxLength={16} value={signUpId} placeholder="영문 대소문자와 숫자 5-19자 조합" onChange={onChangeSignUpId} />
                            <p className="signUpErrorMassage">{signUpIdErrorMassage}</p>
                            {/* <p className="signUpErrorMassage">{signUpIdMassage}</p> */}
                            <SingleButton className="signUpIdDuplicateConform signUpBtn" onChange={signUpIdDuplicateConform} disabled={!isSignUpId}>아이디 중복확인</SingleButton>
                        </div>
                        <div className="emailInputWrap">
                            ...
                            <SingleButton className="emailCertification signUpBtn" disabled={!isSignUpEmail}>이메일 인증하기</SingleButton>
                        </div>
                        <div className="pwInputWrap">
                            <p>비밀번호</p>
                            <InputBox className="pwInput" type="password" name="psw" value={signUpPassword}
                        ...
                        <div className="pwConfirmInputWrap">
                            <p>비밀번호 확인</p>
                            <InputBox className="pwConfirmInput" type="password" name="psw" minLength={8} maxLength={16} value={signUpPasswordConfirm} onChange={onChangeSignUpPasswordConfirm} />
                            <p className="signUpErrorMassage">{signUpPwConfirmMessage}</p>
                        </div>
                        <div className="nameInputWrap">
                            <p>이름</p>
                            <InputBox className="signUpName" type="text" name="Name" value={signUpName} onChange={onChangeSignUpName}
                        ...
                        <div className="tellInputWrap">
                            <p>휴대전화</p>
                            <InputBox className="signUpPhone" type="text" name="signUpPhone" value={signUpPhone} placeholder="숫자만 입력해주세요" onChange={onChangeSignUpPhone} />
                        ...
                        <div className="emailGetRadio">
                            <div>
                                ...
                                <button  onClick={()=>setServicePermition(true)} >자세히 보기</button>
                                {servicePermition ? <ServicePermition onClose={setServicePermition} /> : null}
                            </div>
                            <div>
                                <div>
