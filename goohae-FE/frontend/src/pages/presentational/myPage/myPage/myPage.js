        ...
        <div className="myPageMain">
            ...
            <article className="MyMenuWrap">
                <div className="myPageMenuContainer">
                    <div className="myPageMenu">
                        <Link to="/myOrder" className="myPageMenuTitle">주문 내역
                        </Link>
                        <Link to="/myOrder">
                    ...
                    <div className="myPageMenu">
                        <Link to="/memberInfo" className="myPageMenuTitle">내정보
                        </Link>
                        <Link to="/memberInfo">
                            <p className="myPageMenuContent">
            ...
            <p><a href="../mileage/mileage.html">
                ...
                적립된 금액은 현금으로 환불되지 않습니다.
                    ...
                    <div className="myPageMenu">
                        <Link to='/myCoupon' className="myPageMenuTitle">쿠폰</Link>
                        <Link to='/myCoupon'>
                            <p className="myPageMenuContent">
                    ...
                    <div className="myPageMenu">
                        <Link to="/myPost" className="myPageMenuTitle">내 리뷰</Link>
                        <Link to="/myPost">
                            <p className="myPageMenuContent">
                    ...
                    <div className="myPageMenu">
                        <Link to="/myAddress" className="myPageMenuTitle">
                          내 주소록
                        </Link>
                        <Link to="/myAddress">
                            <p className="myPageMenuContent">
